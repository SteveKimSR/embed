...
;  /*****************************************************
				...
				LDR	R0, =0x5		; R0 = 0x5				R0에 0x5를 넣어준다.
				LDR	R1, =25			; R1 = 25				R1에 25를 넣어준다.
				LDR	R3, =2			; R3 = 2				R3에 2를 넣어준다.
				ADD	R4, R0, R1	; R4 = R0 + R1		R0와 R1을 합한 값을 R4에 넣어준다.
				LSR	R5, R4, R3	; R5 = R4 >> R3		R4를 R3만큼 right shift 한 것을 R5에 넣어준다.
