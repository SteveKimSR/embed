...
;  /*****************************************************
				...
				LDR R1, =10				; int r1 = 10						r1에 10을 넣는다
				LDR R2, =7				; int r2 = 7							r2에 7을 넣는다
				LDR R0, =5				; int r0 = 5							r0에 5를 넣는다.
				
				MUL R1, R1, R2		; r1 = r1 * r2						r1*r2의 값을 r1에 넣는다.
				
				CMP R0, #5				; r0 == 5 ?							cmp로 r0(5)와 5를 비교해준다.
				ADDNE R1, R1, R0	; if(r0 == 5) r1 = r1 + r0		cmp 결과가 not equal이면 r1 + r0을 r1에 넣는다.
				SUBNE R1, R1, R2	; if(r0 == 5) r1 = r1 - r2		cmp 결과가 not equal이면 r1- r2를 r1에 넣는다.
